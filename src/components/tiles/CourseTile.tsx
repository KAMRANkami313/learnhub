...
export default function CourseTile({ course, index }: CourseTileProps) {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border relative overflow-hidden grain-overlay group cursor-pointer active:scale-[0.98] sm:active:scale-100"
      style={{
    ...
    >
      ...
      <div className="relative z-10 p-4 sm:p-5">
        ...
        <div className="flex items-start justify-between mb-3 sm:mb-4">
          ...
          <motion.div className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 ml-2">
            <ArrowRight
              className="w-4 h-4"
